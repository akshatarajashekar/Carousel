...
import { CarouselListType, CarouselListPropType } from "./types";
import { useAppDispatch } from "../hooks";
import { setItem } from "../home/homeReducer";
  ...
  const itemList = displayItemList.map((ele: CarouselListType, i: any) => {
    return (
      <div key={ele.title}  className={`${cssPrefix}__custom_link`}>
          <Card title={ele.title} image={ele.imgPath} />
      </div>
    );
  });
